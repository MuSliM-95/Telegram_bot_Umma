...
export const addressInfoAdminChat = async (data, obj) => {
    ...
    try {
        ...
        await bot.telegram.sendPhoto(id, pathImage((_a = data === null || data === void 0 ? void 0 : data.photo) === null || _a === void 0 ? void 0 : _a.image), {
...
export const addressInfoUserChat = async (data, obj) => {
    var _a;
    const { bot, id } = obj;
    try {
        const inlineKeyboard = {
